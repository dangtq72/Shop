...
namespace NangShop.Control.Created
{
    ...
    /// </summary>
    public partial class FrmCreateSale_Ban_Buon_Header : Window
    {
        public FrmCreateSale_Ban_Buon_Header()
        {
            InitializeComponent();
        }
        ...
        void Get_Product_ByCode(string p_code)
        {
            try
            {
                ...
                if (_lst.Count == 1)
                {
                    ...
                    lblSalePrice.Content = _lst[0].BanBuon_Price.ToString("###,###");
        ...
        void Call_Price_Sale_Header()
        {
            try
            {
                ...
                {
                    item.Total_Price = item.Count_Sale_By_Header * item.BanBuon_Price;
                    _total_p += item.BanBuon_Price * item.Count_Sale_By_Header;
