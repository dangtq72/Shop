...
namespace NangShop.CustomUserControl
{
    ...
    public class FilterControl : System.Windows.Controls.Control
    {
        ...
        private void ApplyFilterOnTarget()
        {
            ...
            object obj = collectionView.SourceCollection;
            if (obj is System.Data.DataView)
            {
                System.Data.DataTable _dt = ((System.Data.DataView)TargetControl.ItemsSource).ToTable();
                ICollectionView MyCollectionView = CollectionViewSource.GetDefaultView(_dt.Rows);
                if (MyCollectionView != null)
                {
                    MyCollectionView.Filter = o => (o as System.Data.DataRow).ItemArray[1].ToString().IndexOf(this.FilterText, StringComparison.InvariantCultureIgnoreCase) > -1;
                }
            }
            else
            {
