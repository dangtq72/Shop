...
namespace NangShop.Display
{
    ...
    /// </summary>
    public partial class HoaDon_Display : DockableContent
    {
        public HoaDon_Display()
        {
            InitializeComponent();
        }
        ...
        private void btnSearch_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                c_lst = c_Sale_Header_Controller.Sale_Header_Search(c_shd, c_str_date, c_str_date_to, c_customer_name, Convert.ToInt16(ThuChi_Type.Ban_Le));
